...
#define __ID3D12CommandQueueDownlevel_INTERFACE_DEFINED__
    ...
    ID3D12CommandQueueDownlevel : IUnknown
    {
        virtual HRESULT STDMETHODCALLTYPE Present(
            _In_ ID3D12GraphicsCommandList * pOpenCommandList, _In_ ID3D12Resource * pSourWETex2D, _In_ HWND hWindow, D3D12_DOWNLEVEL_PRESENT_FLAGS Flags) = 0;
    };
    ...
    typedef struct ID3D12CommandQueueDownlevelVtbl
    {
        ...
        (ID3D12CommandQueueDownlevel* This, _In_ ID3D12GraphicsCommandList* pOpenCommandList, _In_ ID3D12Resource* pSourWETex2D, _In_ HWND hWindow,
...
#define ID3D12CommandQueueDownlevel_Present(This, pOpenCommandList, pSourWETex2D, hWindow, Flags) ((This)->lpVtbl->Present(This, pOpenCommandList, pSourWETex2D, hWindow, Flags))
